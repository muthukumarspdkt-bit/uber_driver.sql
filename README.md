CREATE TABLE drivers (
    ...
    incentive_achieved DECIMAL(30,2) DEFAULT 0.00,
    join_date DATE NOT NULL,
    license_expiry DATE NOT NULL,
    complaints_count INT DEFAULT 0,
    late_arrivals INT DEFAULT 0,
    cancellation_rating DECIMAL(30,2) DEFAULT 0.00,
    total_earnings DECIMAL(30,2) DEFAULT 0.00,
...
('Anil Verma', 'car', 'Hyundai i20', 'Delhi', 'active', 'Vehicle issue - suspension check needed', 367, '1986-06-20', 29400.00, '2021-12-30', '2028-06-20', 6, 14, 3.81, 220200.00, 367, 'Yes', 'Yes', 'Yes', 'Yes');
